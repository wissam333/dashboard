...
***********************************-->
      <div class="nav-header">
        ...
        <div class="nav-control" style="right: 5.812rem; z-index: 9999 !important; display: block !important;">
          <div class="hamburger" style="left: 0px !important; display: block !important;">
            <span class="line" style="background: #DD2F6E !important;"></span><span class="line"
              style="background: #DD2F6E !important;"></span><span class="line"
              style="background: #DD2F6E !important;"></span>
          </div>
        </div>
      </div>
      <!--**********************************
Nav header end
***********************************-->
      <div class="header" style="direction: rtl; padding: 0">
        <div class="header-content" style="padding: 1rem">
                  ...
                  <div class="dropdown-menu dropdown-menu-end" style="right: 0 !important">
                    <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3" style="height: 380px">
                      <ul class="timeline">
                        ...
                        <li>
                          <div class="timeline-panel">
                            <div class="media ms-2 media-info">KG</div>
                            <div class="media-body">
                        ...
                        <li>
                          <div class="timeline-panel">
                            <div class="media ms-2 media-success">
                        ...
                        <li>
                          <div class="timeline-panel">
                            <div class="media ms-2 media-danger">KG</div>
                            <div class="media-body">
                              <h6 class="mb-1">Resport created successfully</h6>
                              <small class="d-block">29 July 2020 - 02:26 PM</small>
                            </div>
                        ...
                        <li>
                          <div class="timeline-panel">
                            <div class="media ms-2 media-primary">
                              <i class="fas fa-home"></i>
                            </div>
                            <div class="media-body">
                              <h6 class="mb-1">Reminder : Treatment Time!</h6>
...
Sidebar start
***********************************-->
      <div class="deznav" style="width: 18rem !important;">
        <div class="deznav-scroll" style="overflow-y: scroll !important;">
          <div class="metismenu" id="menu">
            <div>
              <div style="background-color: transparent; color: #fff; padding: 0.625rem 1.25rem;">
                <i class="flaticon-dashboard-1"></i>
                <span class="nav-text">Dashboard</span>
              </div>
              <div class="deznavul" style="padding: 0;">
                <div>
          ...
          <div class="copyright" style="display: block !important;">
            ...
            <p>Made with <i class="bi bi-suit-heart-fill"></i> by DexignZone</p>
          </div>
        </div>
      </div>
      <!--**********************************
...
.timeline-badge::before {
  background-color: rgb(221, 47, 110) !important;
}
...
.timeline-panel {
  border-color: rgb(221, 47, 110) !important;
